...
learning_curve, best_criterion = train_ls(model, train_dataset, validate_dataset, test_dataset, loss, quality_criterion, config, batch_to_tensors, 
                                        chunk_num=chunk_num, save_path=save_path, exp_name=exp_name, weight_names=weight_names)
